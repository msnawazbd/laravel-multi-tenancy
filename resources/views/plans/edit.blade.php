            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('plans.update', $plan->id) }}">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="post_limit" class="block mt-1 w-full" type="number"
                                      name="post_limit" :value="old('post_limit', $plan->post_limit)" required />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="stripe_plan_id" class="block mt-1 w-full" type="text"
                                      name="stripe_plan_id" :value="old('stripe_plan_id', $plan->stripe_plan_id)" />
